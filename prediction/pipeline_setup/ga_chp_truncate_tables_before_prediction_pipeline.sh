...
HDFS_DIR_PREPROC=hdfs://${MORPHL_SERVER_IP_ADDRESS}:${HDFS_PORT}/${MODEL_DAY_AS_STR}_${UNIQUE_HASH}_ga_chp_preproc_prediction

HDFS_DIR_SC_FEAT=hdfs://${MORPHL_SERVER_IP_ADDRESS}:${HDFS_PORT}/${MODEL_DAY_AS_STR}_${UNIQUE_HASH}_ga_chp_scaled_features_prediction
